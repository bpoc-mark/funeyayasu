            ...
            <footer class="p-footer" id="footer">
                <div class="l-wrap p-footer__inner">
                    ...
                    <div class="p-footer__inner--bottom">
                        <a class="f-card" href="">
                            <div class="bg-img">
                                <img src="<?php echo get_template_directory_uri();?>/release/image/footer/footer_img_1.png"
                                    alt="">
                                <div class="overlay"></div>
                                <div class="overlay_logo">
                                    <img src="<?php echo get_template_directory_uri();?>/release/image/footer/overlay_logo.png"
                                        alt="">
                                </div>
                            </div>
                            <div class="card_txt">
                        ...
                        <a class="f-card" href="">
                            <div class="bg-img">
                                <img src="<?php echo get_template_directory_uri();?>/release/image/footer/footer_img_2.png"
                                    alt="">
                                <div class="overlay"></div>
                                <div class="overlay_logo">
                                    <img src="<?php echo get_template_directory_uri();?>/release/image/footer/overlay_logo.png"
                        ...
                        <a class="f-card" href="">
                            <div class="bg-img">
                                <img src="<?php echo get_template_directory_uri();?>/release/image/footer/footer_img_3.png"
                                    alt="">
                                <div class="overlay"></div>
                                <!-- <div class="overlay_logo">
                            ...
                            <div class="card_txt">
                                ...
                                <span></span>
                                <img src="<?php echo get_template_directory_uri();?>/release/image/footer/footer_img_3_crd.png"
                                    alt="">
                            </div>
                        </a>
                    </div>
